  ...
  const handleDownload = useCallback(async () => {
    ...
    try {
      const downloadOptions = {
        ...
        audioCodec: settings?.download?.audioCodec || "auto",
        videoCodec: settings?.download?.videoCodec || "auto",
        downloadSubtitles: options.downloadSubtitles,
        subtitleLanguages: [options.subtitleLanguage],
        subtitleFormat: settings?.download?.subtitleFormat || "srt",
        ...
        writeInfoJson: settings?.download?.writeInfoJson || false,
        ...
        createChannelSubfolder: settings?.download?.createChannelSubfolder || false,
        includeDateInFilename: settings?.download?.includeDateInFilename || false,
        filenameTemplate: settings?.download?.filenameTemplate || "",
